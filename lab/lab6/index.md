...
[Learn the Networking overview](https://docs.docker.com/network/bridge/)
...
## Docker Networking: CLI examples

- `docker network create my-net` - create a [bridge network](https://docs.docker.com/network/bridge/)
